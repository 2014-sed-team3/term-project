...
{
    public class Tween : DoubleAnimationBase
    {
        /// <summary>
        ...
        public static readonly DependencyProperty EquationProperty =
            DependencyProperty.Register(
                "Equation", typeof(Equations), typeof(Tween),
                new PropertyMetadata(Equations.Linear, new PropertyChangedCallback(HandleEquationChanged)));

        public static readonly DependencyProperty FromProperty =
            DependencyProperty.Register(
                "From", typeof(double), typeof(Tween), new PropertyMetadata(0.0));

        public static readonly DependencyProperty ToProperty =
            DependencyProperty.Register(
                "To", typeof(double), typeof(Tween), new PropertyMetadata(0.0));
        ...
        {
            Tween pda = sender as Tween;

            // cache method so we avoid lookup while animating
            pda._EasingMethod = typeof(Tween).GetMethod(e.NewValue.ToString());
        }
        ...
        /// </summary>
        [TypeConverter(typeof(TweenAnimationTypeConverter))]
    ...
    public class TweenAnimationTypeConverter : TypeConverter
    {
        ...
        {
            foreach (int i in Enum.GetValues(typeof(Tween.Equations)))
            {
                if (Enum.GetName(typeof(Tween.Equations), i) == value.ToString())
                    return (Tween.Equations)i;
            }
            return null;
        }
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (value != null)
            {
                return ((Tween.Equations)value).ToString();
            }
            return null;
        }
    }
