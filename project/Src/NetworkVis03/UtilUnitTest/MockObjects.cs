...
public class MockGraphVertexEdgeBase : GraphVertexEdgeBase
{
...
public class MockVertex : IVertex
{
    public MockVertex()
    {
        m_oParentGraph = null;
...
public class MockMetadataProvider : IMetadataProvider, IIdentityProvider
{
