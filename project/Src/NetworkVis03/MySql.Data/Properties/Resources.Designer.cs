...
namespace MySql.Data.MySqlClient.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   查詢類似 Improper MySqlCommandBuilder state: adapter is null 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Improper MySqlCommandBuilder state: adapter&apos;s SelectCommand is null 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Invalid attempt to access a field before calling Read() 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Authentication to host &apos;{0}&apos; for user &apos;{1}&apos; using method &apos;{2}&apos; failed with message: {3} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Authentication method &apos;{0}&apos; not supported by any of the available plugins. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Version string not in acceptable format 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似  The buffer cannot be null 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似  Buffer is not large enough 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Canceling an executing query requires MySQL 5.0 or higher. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Canceling an active query is only supported on MySQL 5.0.0 and above.  的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Parameters can only be derived for commands using the StoredProcedure command type. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 MySqlCommandBuilder does not support multi-table statements 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 MySqlCommandBuilder cannot operate on tables with no unique or key columns 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Chaos isolation level is not supported 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The CommandText property has not been properly initialized. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The connection is already open. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Connection unexpectedly terminated. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Connection must be valid and open 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The connection is not open. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The connection property has not been set or is null. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Could not find specified column in results: {0} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似  Count cannot be negative 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 SetLength is not a valid operation on CompressedStream 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The given value was not in a supported format. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 There is already an open DataReader associated with this Connection which must be closed first. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The default connection encoding was not found. Please report this as a bug along with your connection string and system details. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 MySQL Connector/Net does not currently support distributed transactions. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Error creating socket connection 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Fatal error encountered during command execution. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Fatal error encountered during data read. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Fatal error encountered attempting to read the resultset. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 File based certificates are only supported when connecting to MySQL Server 5.1 or greater. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 From index and length use more bytes than from contains 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 From index must be a valid index inside the from buffer 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Call to GetHostEntry failed after {0} while querying for hostname &apos;{1}&apos;: SocketErrorCode={2}, ErrorCode={3}, NativeErrorCode={4}. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Retrieving procedure metadata for {0} from server. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Value has an unsupported format. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 An incorrect response was received from the server. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Index and length use more bytes than to has room for 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Index must be a valid position in the buffer 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 You have specified an invalid column ordinal. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The requested value &apos;{0}&apos; is invalid for the given keyword &apos;{1}&apos;. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Procedure or function &apos;{0}&apos; cannot be found in database &apos;{1}&apos;. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 &apos;{0}&apos; is an illegal value for a boolean option. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Keyword does not allow null values. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Keyword not supported. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Mixing named and unnamed parameters is not allowed. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 INTERNAL ERROR:  More than one output parameter row detected. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Multiple simultaneous connections or connections with different connection strings inside the same transaction are not currently supported. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 NamedPipeStream does not support seeking 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 NamedPipeStream doesn&apos;t support SetLength 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The new value must be a MySqlParameter object. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Invalid attempt to call NextResult when the reader is closed. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 When calling stored procedures and &apos;Use Procedure Bodies&apos; is false, all parameters must have their type explicitly set. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Nested transactions are not supported. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The host {0} does not support SSL connections. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Unix sockets are not supported on Windows. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Cannot retrieve Windows identity for current user. Connections that use  IntegratedSecurity cannot be  pooled. Use either &apos;ConnectionReset=true&apos; or  &apos;Pooling=false&apos; in the connection string to fix. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The object is not open or has been disposed. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似  Offset cannot be negative 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Offset must be a valid position in buffer 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Authentication with old password no longer supported, use 4.1 style passwords. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Parameter &apos;{0}&apos; has already been defined. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Parameter cannot have a negative value 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Parameter cannot be null 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Parameter index was not found in Parameter Collection. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Parameter is invalid. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Parameter &apos;{0}&apos; must be defined. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Parameter &apos;{0}&apos; was not found during prepare. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Password must be valid and contain length characters 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 This category includes a series of counters for MySQL. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 .NET Data Provider for MySQL 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The number of times a procedures metadata had to be queried from the server. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Hard Procedure Queries 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The number of times a procedures metadata was retrieved from the client-side cache. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Soft Procedure Queries 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 same name are not supported. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Packets larger than max_allowed_packet are not allowed. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Reading from the stream has failed. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Invalid attempt to read a prior column using SequentialAccess 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Replicated connections allow only readonly statements. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Attempt to connect to &apos;{0}&apos; server failed. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 No available server found. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Replication group &apos;{0}&apos; not found. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Replicated server not found: &apos;{0}&apos; 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Routine &apos;{0}&apos; cannot be found. Either check the spelling or make sure you have sufficient rights to execute the routine. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Attempt to call stored function &apos;{0}&apos; without specifying a return parameter 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Connector/Net no longer supports server versions prior to 5.0 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Snapshot isolation level is not supported. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Socket streams do not support seeking 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Retrieving procedure metadata for {0} from procedure cache. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Stored procedures are not supported on this version of MySQL 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The stream has already been closed 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似  The stream does not support reading 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The stream does not support writing 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Timeout expired.  The timeout period elapsed prior to completion of the operation or the server is not responding. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 error connecting: Timeout expired.  The timeout period elapsed prior to obtaining a connection from the pool.  This may have occurred because all pooled connections were in use and max pool size was reached. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Connection Closed 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Unable to trace.  There are more than Int32.MaxValue connections in use. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Error encountered during row fetch. Number = {1}, Message={2} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Connection Opened: connection string = &apos;{1}&apos; 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Error encountered attempting to open result: Number={1}, Message={2} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Query Normalized: {2} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Query Opened: {2} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Resultset Opened: field(s) = {1}, affected rows = {2}, inserted id = {3} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Resultset Closed. Total rows={1}, skipped rows={2}, size (bytes)={3} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Set Database: {1} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Statement closed: statement id = {1} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Statement executed: statement id = {1} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Statement prepared: sql=&apos;{1}&apos;, statement id={2} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Usage Advisor Warning: Query is using a bad index 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Usage Advisor Warning: The field &apos;{2}&apos; was converted to the following types: {3} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Usage Advisor Warning: Query does not use an index 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Usage Advisor Warning: The following columns were not accessed: {2} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: Usage Advisor Warning: Skipped {2} rows. Consider a more focused query. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 {0}: MySql Warning: Level={1}, Code={2}, Message={3} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Type &apos;{0}&apos; is not derived from BaseCommandInterceptor 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Type &apos;{0}&apos; is not derived from BaseExceptionInterceptor 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Unable to connect to any of the specified MySQL hosts. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Unable to create plugin for authentication method &apos;{0}&apos;. Please see inner exception for details. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Unable to derive stored routine parameters.  The &apos;Parameters&apos; information schema table is not available and access to the stored procedure body has been disabled. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Unable to enable query analysis.  Be sure the MySql.Data.EMTrace assembly is properly located and registered. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 An error occured attempting to enumerate the user-defined functions.  Do you have SELECT privileges on the mysql.func table? 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Unable to execute stored procedure &apos;{0}&apos;. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 There was an error parsing the foreign key definition. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Unable to retrieve stored procedure metadata for routine &apos;{0}&apos;.  Either grant  SELECT privilege to mysql.proc for this user or use &quot;check parameters=false&quot; with  your connection string. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Unable to start a second async operation while one is running. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Unknown authentication method &apos;{0}&apos; was requested. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Unknown connection protocol 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Value &apos;{0}&apos; is not of the correct type. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 The requested column value could not be treated as or conveted to a Guid. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Windows authentication connections are not supported on {0} 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Writing to the stream failed. 的當地語系化字串。
        /// </summary>
        ...
        /// <summary>
        ///   查詢類似 Parameter &apos;{0}&apos; is not found but a parameter with the name &apos;{1}&apos; is found. Parameter names must include the leading parameter marker. 的當地語系化字串。
        /// </summary>
